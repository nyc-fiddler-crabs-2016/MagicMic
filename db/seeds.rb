...
user3 = User.create!(username: "mattgaryjoe", email: "mattgaryjoe@gmail.com", password: "password")
user4 = User.create!(username: "steve3", email: "thethirdstevedave@gmail.com", password: "password")

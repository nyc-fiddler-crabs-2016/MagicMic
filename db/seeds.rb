...
broadcast6 = Broadcast.create!(topic: "The State of the Onion", speaker_id: 1, datetime: DateTime.new(2016,4,6,19,00, -5))
broadcast7 = Broadcast.create!(topic: "Rails Magic and How to Use It", speaker_id: 1 )
broadcast8 = Broadcast.create!(topic: "The Secrets of the Rails Wizards", speaker_id: 1, datetime: DateTime.new(2016,4,6,18,00, -5))
broadcast9 = Broadcast.create!(topic: "Beware the Coming of the Nice Age", speaker_id: 4, datetime: DateTime.new(2016,4,6,17,00, -5))
broadcast10 = Broadcast.create!(topic: "MarioKart Racers: Where Are They Now?", speaker_id: 4, datetime: DateTime.new(2016,4,6,16,00, -5))
